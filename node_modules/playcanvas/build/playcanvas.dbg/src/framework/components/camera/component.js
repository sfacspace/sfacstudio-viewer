 ...
 */ class CameraComponent extends Component {
     ...
     */ _enableDepthLayer(value) {
        ...
        if (hasDepthLayer) {
            /** @type {Layer} */ const depthLayer = this.system.app.scene.layers.getLayerById(LAYERID_DEPTH);
            if (value) {
     ...
     * @type {number}
     * @private
     */ this._renderSceneColorMap = 0, /** @private */ this._sceneDepthMapRequested = false, /** @private */ this._sceneColorMapRequested = false, /** @private */ this._priority = 0, /**
     * Layer id at which the postprocessing stops for the camera.
     *
     * @type {number}
     * @private
     */ this._disablePostEffectsLayer = LAYERID_UI, /** @private */ this._camera = new Camera(), /**
