...
import { PROJECTION_PERSPECTIVE, PROJECTION_ORTHOGRAPHIC, ASPECT_AUTO, LAYERID_WORLD, LAYERID_DEPTH, LAYERID_SKYBOX, LAYERID_UI, LAYERID_IMMEDIATE } from './constants.js';
 ...
 */ class Camera {
     ...
     */ this.renderPasses = [];
        ...
        this._jitters = [
            ...
            0,
            0
        ]; // jitter values for TAA, 0-1 - current frame, 2-3 - previous frame
