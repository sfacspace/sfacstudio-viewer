...
import { SHADOWUPDATE_NONE, SHADOWUPDATE_THISFRAME, LIGHTTYPE_DIRECTIONAL, LIGHTTYPE_OMNI, shadowTypeInfo, SHADOW_PCF3_32F, SHADOW_PCSS_32F, SHADOW_PCF1_32F, SHADOW_PCF1_16F, SHADOW_PCF3_16F, SHADOW_VSM_32F, SHADOW_VSM_16F, MASK_BAKE, LIGHTTYPE_SPOT, MASK_AFFECT_DYNAMIC, MASK_AFFECT_LIGHTMAPPED, LIGHT_COLOR_DIVIDER, LIGHTFALLOFF_LINEAR, BLUR_GAUSSIAN, LIGHTSHAPE_PUNCTUAL, SHADOWUPDATE_REALTIME } from './constants.js';
 ...
 */ class LightRenderData {
    ...
    constructor(camera, face, light){
        ...
        /** @type {BindGroup[]} */ this.viewBindGroups = [];
    }
}
/**
 * A light.
 ...
 */ class Light {
     ...
     */ getClusteredFlags(castShadows, useCookie) {
        return this.clusteredFlags | ((castShadows ? Math.floor(this.shadowIntensity * 255) : 0) & 0xFF) << 0 | // bits 7 - 0
