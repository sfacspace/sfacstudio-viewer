 ...
 */ /** @type {Set<number>} */ const _neededIds = new Set();
class GSplatUnifiedSorter extends EventHandler {
     ...
     */ constructor(scene){
        super(), this.bufferLength = 0, this.availableOrderData = [], // track how many jobs are in flight
        this.jobsInFlight = 0, // true if we have new version to process
        this.hasNewVersion = false, /**
     ...
     */ this.pendingSorted = null, /** @type {Set<number>} */ this.centersSet = new Set(), /** @type {boolean} */ this._destroyed = false, /** @type {Scene|null} */ this.scene = null;
